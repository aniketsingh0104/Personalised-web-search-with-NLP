...
def compareAndMerge(grp_id):
    ...
    grp2_keywords = None
    max_match = 0
    group1_keywords = read_dictionary(f"data/group_profiles/group_keywords/{grp_id}_group_keywords.npy")
    for g_id in GRP_IDS:
        group2_keywords = read_dictionary(f"data/group_profiles/group_information/{g_id}_group_keywords.npy")
